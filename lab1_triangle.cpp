...
int Triangle(array<double, 3>& sides){ // ссылка & нужна, чтобы не создавалась копия контейнера, т.е. работа программы ускоряется и в памяти не занимается лишнее место
